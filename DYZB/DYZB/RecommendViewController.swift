...
//            cell = collectionView.dequeueReusableCell(withReuseIdentifier: kPretyReuseIdentifier, for: indexPath)
//        } else {
            cell = collectionView.dequeueReusableCell(withReuseIdentifier: kNormalReuseIdentifier, for: indexPath)
//        }
